...
const isActive = (itemPath) => {
  ...
  <li
    ...
    className={`${isActive(item.path)
      ...
      : "text-gray-500"}
      cursor-pointer h-full flex items-center hover:bg-blue-900 group transition-all duration-300`}
  >
    <Link
      href={item.path}
      className="flex flex-col items-center w-full group-hover:text-white"
    >
